$(function() {
    ...
    if ($('header .menu').length > 0) {
        ...
        $(window).bind("load scroll resize", function(e) {
            ...
            if (ww >= wwMedium && $(this).scrollTop() > stickyMenuTop) {
                ...
                $('.wrapper').css('background-position', 'center -300px');
    ...
    $('.font_size').find('.small').click(function(e) {
        ...
        $('.main').removeClass('large_size medium-size').addClass('small_size');
    ...
    $('.font_size').find('.medium').click(function(e) {
        $(this).parent('li').siblings('li').find('a').removeClass('active');
        $('.main').removeClass('large_size small_size').addClass('medium-size');
        $(this).addClass('active');
        e.preventDefault();
    ...
    $('.font_size').find('.large').click(function(e) {
        $(this).parent('li').siblings('li').find('a').removeClass('active');
        $('.main').removeClass('small_size medium-size').addClass('large_size');
        $(this).addClass('active');
        e.preventDefault();
    ...
    $('table').each(function(index, el) {
        //判斷沒有table_list
        if ($(this).parents('.table_list').length == 0 && $(this).parents('.fix_th_table').length == 0 && $(this).parent('form').length == 0 && $(this).parent('.calendar_table').length == 0) {
            $(this).scroltable();
        }
    });
